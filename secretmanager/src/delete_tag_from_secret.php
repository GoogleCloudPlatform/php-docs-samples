...
// [START secretmanager_delete_tag_from_secret]
...
/**
 * Delete a tag binding from a secret.
 *
 * @param string $projectId Your Google Cloud Project ID (e.g. 'my-project')
 * @param string $secretId  Your secret ID (e.g. 'my-secret')
 * @param string $tagValue  Your tag value resource name (e.g. 'tagValues/123')
 */
function delete_tag_from_secret(string $projectId, string $secretId, string $tagValue): void
{
...
// [END secretmanager_delete_tag_from_secret]
