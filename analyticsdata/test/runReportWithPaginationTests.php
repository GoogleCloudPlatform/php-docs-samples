...
class runReportWithPaginationTests extends TestCase
{
    use TestTrait;

    public function testrunReportWithPagination()
    {
        $file = sys_get_temp_dir() . '/analyticsdata_run_report_with_pagination';
        $contents = file_get_contents(__DIR__ . '/../run_report_with_pagination.php');
        ...
        // Invoke run_report_with_pagination.php
