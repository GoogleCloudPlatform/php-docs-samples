...
class runPivotReportTests extends TestCase
{
    use TestTrait;

    public function testrunPivotReport()
    {
        $file = sys_get_temp_dir() . '/analyticsdata_run_pivot_report';
        $contents = file_get_contents(__DIR__ . '/../run_pivot_report.php');
