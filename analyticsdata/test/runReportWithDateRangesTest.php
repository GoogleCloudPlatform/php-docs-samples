...
class runReportWithDateRangesTest extends TestCase
{
    use TestTrait;

    public function testrunReportWithDateRanges()
    {
        $file = sys_get_temp_dir() . '/analyticsdata_run_report_with_date_ranges';
        $contents = file_get_contents(__DIR__ . '/../run_report_with_date_ranges.php');
        ...
        // Invoke run_report_with_date_ranges.php
