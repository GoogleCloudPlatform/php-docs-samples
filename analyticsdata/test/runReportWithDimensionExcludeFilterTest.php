...
class runReportWithDimensionExcludeFilterTest extends TestCase
{
    ...
    {
        $file = sys_get_temp_dir() . '/analyticsdata_run_report_with_dimension_exclude_filter';
        $contents = file_get_contents(__DIR__ . '/../run_report_with_dimension_exclude_filter.php');
        ...
        // Invoke run_report_with_dimension_exclude_filter.php
