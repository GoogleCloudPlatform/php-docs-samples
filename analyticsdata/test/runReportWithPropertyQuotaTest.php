...
class runReportWithPropertyQuotaTests extends TestCase
{
    ...
    {
        $file = sys_get_temp_dir() . '/analyticsdata_run_report_with_property_quota';
        $contents = file_get_contents(__DIR__ . '/../run_report_with_property_quota.php');
        ...
        // Invoke run_report_with_property_quota.php
