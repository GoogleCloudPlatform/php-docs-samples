...
class getCommonMetadataTests extends TestCase
{
    use TestTrait;

    public function testgetCommonMetadata()
    {
        $file = sys_get_temp_dir() . '/analyticsdata_get_common_metadata';
        $contents = file_get_contents(__DIR__ . '/../get_common_metadata.php');
        ...
        // Invoke get_common_metadata.php
