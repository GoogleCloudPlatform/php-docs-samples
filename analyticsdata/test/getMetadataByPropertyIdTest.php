...
class getMetadataByPropertyIdTest extends TestCase
{
    ...
    {
        $file = sys_get_temp_dir() . '/analyticsdata_get_metadata_by_property_id';
        $contents = file_get_contents(__DIR__ . '/../get_metadata_by_property_id.php');
        ...
        // Invoke get_metadata_by_property_id.php
