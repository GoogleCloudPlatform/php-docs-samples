...
$cryptoKeyVersions = $kms->listCryptoKeyVersions($cryptoKeyName);
foreach ($cryptoKeyVersions as $cryptoKeyVersion) {
    printf("Name: %s\nCreate Time: %s\nState: %s\n\n",
        $cryptoKeyVersion->getName(),
        date('Y-m-d H:i:s', $cryptoKeyVersion->getCreateTime()->getSeconds()),
