...
class kmsTest extends TestCase
{
    ...
    public function testDestroyRestoreKeyVersion()
    {
        ...
        $this->assertStringContainsString($version->getState(), array(
    ...
    public function testIamAddMember()
    {
        ...
        $this->assertStringContainsString('group:test@google.com', $binding->getMembers());
    }
    ...
    public function testIamRemoveMember()
    {
        ...
        $this->assertNotNull($binding);
        $this->assertStringContainsString('group:tester@google.com', $binding->getMembers());
