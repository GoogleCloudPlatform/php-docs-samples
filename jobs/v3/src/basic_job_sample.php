...
use Google_Service_CloudTalentSolution_ApplicationInfo;
use Google_Service_CloudTalentSolution_CreateJobRequest;
use Google_Service_CloudTalentSolution_Job;
use Google_Service_CloudTalentSolution_UpdateJobRequest;
...
final class BasicJobSample extends Command
{
    ...
    public static function generate_job_with_required_fields($companyName)
    {
        ...
        $applicationUrls = new Google_Service_CloudTalentSolution_ApplicationInfo();
        $applicationUrls->setUris(array('http://careers.google.com'));
        $job->setApplicationInfo($applicationUrls);
     ...
     *
     * @param string $parent
     * @param Google_Service_CloudTalentSolution_Job $jobToBeCreated
     * @return Google_Service_CloudTalentSolution_Job
     */
    public static function create_job($parent, Google_Service_CloudTalentSolution_Job $jobToBeCreated)
    {
        $jobService = self::get_job_service();

        $createJobRequest = new Google_Service_CloudTalentSolution_CreateJobRequest();
        $createJobRequest->setJob($jobToBeCreated);
        $jobCreated = $jobService->projects_jobs->create($parent, $createJobRequest);
    ...
    public static function get_job($jobName)
    {
        ...
        $jobExisted = $jobService->projects_jobs->get($jobName);
     ...
     *
     * @param string $jobName
     * @param Google_Service_CloudTalentSolution_Job $jobToBeUpdated
     * @return Google_Service_CloudTalentSolution_Job
     */
    public static function update_job($jobName, Google_Service_CloudTalentSolution_Job $jobToBeUpdated)
    {
        $jobService = self::get_job_service();

        $updateJobRequest = new Google_Service_CloudTalentSolution_UpdateJobRequest();
        $updateJobRequest->setJob($jobToBeUpdated);
        $jobUpdated = $jobService->projects_jobs->patch($jobName, $updateJobRequest);
    ...
    public static function update_job_with_field_mask(
        $jobName,
        $fieldMask,
        Google_Service_CloudTalentSolution_Job $jobToBeUpdated
    ) {
        $jobService = self::get_job_service();

        $updateJobRequest = new Google_Service_CloudTalentSolution_UpdateJobRequest();
        $updateJobRequest->setJob($jobToBeUpdated);
        $updateJobRequest->setUpdateMask($fieldMask);
    ...
    public static function delete_job($jobName)
    {
        ...
        $jobService->projects_jobs->delete($jobName);
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $companyCreated = BasicCompanySample::create_company($parent, $companyToBeCreated);
        ...
        // Create a job.
        $jobCreated = self::create_job($parent, $jobToBeCreated);
        ...
        // Update a job with field mask.
        $jobToBeUpdated = new Google_Service_CloudTalentSolution_Job();
        $jobToBeUpdated->setTitle('changedJobTitle');
