 ...
 * @param string $origin The origin from which the CORS config will allow requests. (e.g. 'http://example.appspot.com')
 * @param string $responseHeader The response header to share across origins. (e.g. 'Content-Type')
 * @param int $maxAgeSeconds The maximum amount of time the browser can make (e.g. 3600)
