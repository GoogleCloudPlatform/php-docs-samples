 ...
 * @param string[] $members The member(s) associated with this binding. (e.g. ['group:example@google.com'])
 ...
 * @param string $expression The condition specified in CEL expression language. (e.g. 'resource.name.startsWith("projects/_/buckets/bucket-name/objects/prefix-a-")')
 *
