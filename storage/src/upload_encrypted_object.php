 ...
 * @param string $source The path to the file to upload. (e.g. '/path/to/your/file')
 * @param string $base64EncryptionKey The base64 encoded encryption key. (e.g. 'TIbv/fjexq+VmtXzAlc63J4z5kFmWJ6NdAPQulQBT7g=')
 */
