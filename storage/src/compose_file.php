 ...
 * @param string $firstObjectName The name of the first GCS object to compose. (e.g. 'my-object-1')
 * @param string $secondObjectName The name of the second GCS object to compose. (e.g. 'my-object-2')
 * @param string $targetObjectName The name of the object to be created. (e.g. 'composed-my-object-1-my-object-2')
 */
