 ...
 * @param string $location Location for the bucket's regions. Case-insensitive. (e.g. 'US')
 * @param string $region1 First region for the bucket's regions. Case-insensitive. (e.g. 'US-EAST1')
 * @param string $region2 Second region for the bucket's regions. Case-insensitive. (e.g. 'US-WEST1')
 */
