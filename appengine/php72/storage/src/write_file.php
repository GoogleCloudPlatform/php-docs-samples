...
# [START gae_storage_write_file]
/**
 * Write to a Storage bucket.
 * @see https://cloud.google.com/appengine/docs/php/googlestorage/#simple_file_write
 */
function write_file($bucketName, $objectName, $contents)
{
    file_put_contents("gs://${bucketName}/${objectName}", $contents);
}
# [END gae_storage_write_file]
